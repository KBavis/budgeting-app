 ...
 * Displays "Step X of Y" with step title and animated progress segments.
 */
const StepProgress = ({ currentStep = 1, totalSteps = 4, steps = ["Register", "Connect Accounts", "Income", "Allocations"] }) => {
   return (
