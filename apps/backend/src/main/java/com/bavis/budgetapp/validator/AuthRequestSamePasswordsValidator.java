 ...
 * @author Kellen Bavis
 *
 *         Validation class for ensuring AuthRequest correctly confirm their
 *         password
 *         - Each password specified in AuthRequest are the same
 */
public class AuthRequestSamePasswordsValidator
        implements ConstraintValidator<AuthRequestSamePasswords, AuthRequestDto> {
    ...
    /**
     * Validates each of the passed in 'password' attributes for our AuthRequestDto
     * match
     *
     * @param authRequestDto
     *                                   - AuthRequestDto to validate 'password'
     *                                   attributes for
