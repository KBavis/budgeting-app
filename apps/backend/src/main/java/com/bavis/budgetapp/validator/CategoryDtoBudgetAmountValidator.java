 ...
 * @author Kellen Bavis
 *
 *         Validation class for ensuring CategoryDto contains valid
 *         'budgetamount' attribute
 *         - Ensures the allocated amount is greater than 0
 */
public class CategoryDtoBudgetAmountValidator
        implements ConstraintValidator<CategoryDtoValidBudgetAmount, CategoryDto> {
     ...
     *
     * @param categoryDto
     *                                   - CategoryDto to verify the budget amount
     *                                   for
