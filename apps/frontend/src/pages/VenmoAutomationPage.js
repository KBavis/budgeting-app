...
const VenmoAutomationPage = () => {
    ...
    return (
        <div className={`flex flex-col min-h-screen ${
            ...
            <div className="flex flex-col items-center px-3 sm:px-6 md:px-12 h-full pt-14 sm:pt-16">
                {/* Header */}
                <div className="max-w-xl w-full text-center mb-4 sm:mb-6 mt-3 sm:mt-5">
                    <h2 className={`text-3xl sm:text-4xl md:text-5xl font-black mb-1.5 sm:mb-2 ${isDark ? "text-white" : "text-slate-900"}`}>
                        Venmo Automation
                    </h2>
                ...
                <div className="w-full max-w-xl flex flex-col gap-4 sm:gap-5 pb-16">

                    {/* Case 1: Automation Not Configured Yet */}
                    {!settings ? (
                        <div className={`border rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl backdrop-blur-sm ${
                            isDark
                            ...
                            <div className="flex items-start gap-3 mb-5">
                                ...
                                <div>
                                    <h3 className={`text-base sm:text-lg font-bold mb-1 ${isDark ? "text-white" : "text-slate-900"}`}>
                            ...
                            <div className="mb-6">
                                <label className={`block text-[11px] sm:text-xs font-extrabold uppercase tracking-wider mb-2 ${
                                ...
                                <div className="grid grid-cols-2 gap-2 sm:gap-2.5">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 p-2.5 sm:p-3 rounded-xl sm:rounded-2xl border text-[11px] sm:text-xs font-bold transition-all ${
                                        ...
                                        >
                                            <span className="text-sm sm:text-base">{prov.icon}</span>
                            ...
                            <button
                                ...
                                disabled={enabling}
                                className="w-full flex items-center justify-center gap-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl sm:rounded-2xl px-5 sm:px-6 py-3 sm:py-3.5 text-xs sm:text-sm font-extrabold transition-all duration-300 shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                {enabling ? (
                                    <>
                            ...
                            <div className={`border rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl backdrop-blur-sm ${
                                ...
                                <div className="flex items-center justify-between gap-2 mb-4">
                                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                                        <div className={`w-9 sm:w-10 h-9 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 ${
                                            ...
                                            {isComplete ? <FaCheck className="w-4 h-4 sm:w-5 sm:h-5" /> : <FaSlidersH className="w-3.5 h-3.5 sm:w-4 sm:h-4" />}
                                        </div>
                                        <div className="min-w-0">
                                            ...
                                            <p className={`text-[11px] sm:text-xs opacity-75 truncate ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                                                {settings.enabled
                                                    ? isComplete
                                                        ? "Venmo payment emails are parsed automatically."
                                                        : "Complete setup steps below to finish."
                                                    : "Re-enable automation at any time."}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-1 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-[11px] sm:text-xs font-extrabold transition-all flex-shrink-0 ${
                                            settings.enabled
                                                ? isDark
                                    ...
                                    >
                                        {settings.enabled ? (
                                            <><FaToggleOn className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Disable</>
                                        ) : (
                                            <><FaToggleOff className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Enable</>
                                        )}
                                    </button>
                                </div>
                            ...
                            {settings.enabled && !isComplete && (
                                <div className={`border rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-xl backdrop-blur-sm ${
                                    ...
                                    <div className="mb-5 sm:mb-6">
                                        <label className={`block text-[11px] sm:text-xs font-extrabold uppercase tracking-widest mb-2 ${
                                            isDark ? "text-slate-400" : "text-slate-500"
                                        }`}>
                                            Your Unique Forwarding Address
                                        </label>
                                        <div className={`flex flex-col xs:flex-row items-stretch xs:items-center gap-2 p-2.5 sm:p-3 rounded-xl ${
                                            ...
                                            <div className="flex items-center gap-2 min-w-0 flex-1">
                                                ...
                                                <code className={`text-[11px] xs:text-xs md:text-sm font-mono font-bold break-all xs:truncate ${
                                                    isDark ? "text-indigo-300" : "text-indigo-700"
                                                }`}>
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold transition-all flex-shrink-0 ${
                                                    copied
                                                        ? "bg-emerald-500/20 text-emerald-400"
                                                        : isDark
