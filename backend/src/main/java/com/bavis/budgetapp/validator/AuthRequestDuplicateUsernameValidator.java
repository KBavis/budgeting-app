 ...
 * @author Kellen Bavis
 *
 *         Validation class to ensure that the 'username' passed in for our
 *         AuthRequest is unique
 *         - Username isn't already registered to corresponding user
 */
@Component
public class AuthRequestDuplicateUsernameValidator
        implements ConstraintValidator<AuthRequestDuplicateUsername, AuthRequestDto> {
