 ...
 *         - Contains only lowercase/uppercase letters, digits, underscores, or
 *         hyphens
 *         - Minimum of 6 characters long and at most 20 characters long
 */
public class AuthRequestUsernameFormatValidator
        implements ConstraintValidator<AuthRequestValidUsername, AuthRequestDto> {

    // Validates all characters are a letter ,digit, underscore, or hyphen AND is
     ...
     *                                   - AuthRequestDto to validate 'username'
     *                                   attribute for
